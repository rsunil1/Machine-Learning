...
The following packages were used in the follwing analysis caret, doParallel and randomForest package, and read in the training and testing data:

```{r}
library(caret)
library(doParallel)
library(randomForest)
ptrain <- read.csv("C:\\Users\\Sailesh\\Desktop\\sunil\\pml-training.csv")
ptest <- read.csv("C:\\Users\\Sailesh\\Desktop\\sunil\\pml-testing.csv")
```
